...
function seed(db: DatabaseSync) {
  ...
  // --- пользователи ---
  const adminId = user("admin@forkwork.ru", "admin123", "Администратор ForkWork", "admin", "🛡️", 90);
  ...
  dish(sofia, "Токпокки", "Рисовые клёцки в соусе кочуджан.", 370, "🌶️", "острое,стритфуд");
