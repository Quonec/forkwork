  ...
  return (
    <div className="card overflow-hidden">
      ...
      <p className="border-t border-stone-100 px-5 py-3 text-[11px] text-stone-400">
        Предпросмотр локальный — отсюда видео никуда не передаётся. Реальное вещание включается на странице эфира:
        создайте эфир ниже, откройте его и нажмите «Включить камеру и вещать».
